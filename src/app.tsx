...
export function App() {
  ...
  function onNewEmailToInvite (event: FormEvent<HTMLFormElement>) {
  ...
  function removeEmailFromInvitest (emailToRemove: string) {
      ...
      {isGuestsModalOpen && (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map((email) => (
                <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                  ...
                  <button type='button'>
                    <X onClick={() => removeEmailFromInvitest(email)} className='size-4 text-zinc-400'/>
                  </button>
                </div>
              ))}
            </div>
            ...
            <form onSubmit={onNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rouded-lg flex items-center'>
              ...
              <button type='submit' onClick={openGuestsInputs} className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
                Convidar
